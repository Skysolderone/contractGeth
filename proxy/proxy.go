...
var ProxyMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_logic_contract\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"stateMutability\":\"nonpayable\",\"type\":\"fallback\"},{\"inputs\":[],\"name\":\"logic_contract\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
	Bin: "",
}
...
func DeployProxy(auth *bind.TransactOpts, backend bind.ContractBackend, _logic_contract common.Address) (common.Address, *types.Transaction, *Proxy, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ProxyBin), backend, _logic_contract)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_Proxy *ProxyCaller) LogicContract(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Proxy.contract.Call(opts, &out, "logic_contract")
...
//
// Solidity: function logic_contract() view returns(address)
func (_Proxy *ProxySession) LogicContract() (common.Address, error) {
	return _Proxy.Contract.LogicContract(&_Proxy.CallOpts)
}

// LogicContract is a free data retrieval call binding the contract method 0x4de94320.
//
// Solidity: function logic_contract() view returns(address)
func (_Proxy *ProxyCallerSession) LogicContract() (common.Address, error) {
	return _Proxy.Contract.LogicContract(&_Proxy.CallOpts)
}
